...
bool operator ==(Object other) {
  final _this = this as TicTacToeGameEvent;
  return identical(this, other) || (other.runtimeType == runtimeType&&other is TicTacToeGameEvent&&(identical(other.player, _this.player) || other.player == _this.player)&&(identical(other.location, _this.location) || other.location == _this.location));
}
...
int get hashCode {
  final _this = this as TicTacToeGameEvent;
  return Object.hash(runtimeType,_this.player,_this.location);
}

@override
String toString() {
  final _this = this as TicTacToeGameEvent;
  return 'TicTacToeGameEvent(player: ${_this.player}, location: ${_this.location})';
}
...
@pragma('vm:prefer-inline') @override $Res call({Object? player = null,Object? location = null,}) {
  return _then(TicTacToeGameEvent(
...
@override
int get hashCode {
    return Object.hash(runtimeType,player,location);
}
...
@override
bool operator ==(Object other) {
  final _this = this as TicTacToeGame;
  return identical(this, other) || (other.runtimeType == runtimeType&&other is TicTacToeGame&&const DeepCollectionEquality().equals(other.board, _this.board)&&(identical(other.currentPlayer, _this.currentPlayer) || other.currentPlayer == _this.currentPlayer)&&(identical(other.type, _this.type) || other.type == _this.type));
}
...
int get hashCode {
  final _this = this as TicTacToeGame;
  return Object.hash(runtimeType,const DeepCollectionEquality().hash(_this.board),_this.currentPlayer,_this.type);
}

@override
String toString() {
  final _this = this as TicTacToeGame;
  return 'TicTacToeGame(board: ${_this.board}, currentPlayer: ${_this.currentPlayer}, type: ${_this.type})';
}
...
@override
int get hashCode {
    return Object.hash(runtimeType,const DeepCollectionEquality().hash(board),currentPlayer,type);
}
