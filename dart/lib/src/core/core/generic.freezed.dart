...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,time,status,round,const DeepCollectionEquality().hash(players),const DeepCollectionEquality().hash(readyPlayers));
...
GenericEvent _$GenericEventFromJson(
  Map<String, dynamic> json
    ...
    return ReadyNextRound.fromJson(
      json
    );
}
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is GenericEvent&&(identical(other.player, player) || other.player == player)&&(identical(other.type, type) || other.type == type));
}
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( ReadyNextRound value)?  readyNextRound,required TResult orElse(),}){
final _that = this;
switch (_that) {
case ReadyNextRound() when readyNextRound != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( ReadyNextRound value)  readyNextRound,}){
final _that = this;
switch (_that) {
case ReadyNextRound():
return readyNextRound(_that);}
}
/// A variant of `map` that fallback to returning `null`.
///
/// It is equivalent to doing:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( ReadyNextRound value)?  readyNextRound,}){
final _that = this;
switch (_that) {
case ReadyNextRound() when readyNextRound != null:
return readyNextRound(_that);case _:
...
switch (_that) {
case ReadyNextRound():
return readyNextRound(_that.player,_that.type);}
}
/// A variant of `when` that fallback to returning `null`
///
/// It is equivalent to doing:
...
class ReadyNextRound extends GenericEvent {
  ...
  factory ReadyNextRound.fromJson(Map<String, dynamic> json) => _$ReadyNextRoundFromJson(json);
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$ReadyNextRoundCopyWith<ReadyNextRound> get copyWith => _$ReadyNextRoundCopyWithImpl<ReadyNextRound>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$ReadyNextRoundToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ReadyNextRound&&(identical(other.player, player) || other.player == player)&&(identical(other.type, type) || other.type == type));
}
...
/// @nodoc
abstract mixin class $ReadyNextRoundCopyWith<$Res> implements $GenericEventCopyWith<$Res> {
  factory $ReadyNextRoundCopyWith(ReadyNextRound value, $Res Function(ReadyNextRound) _then) = _$ReadyNextRoundCopyWithImpl;
@override @useResult
$Res call({
 String player, String type
});
...
class _GameConfig extends GameConfig {
  const _GameConfig({required this.gameType, this.adminID, this.nameSet = NameSet.basic, this.customNames = false, this.rounds = 15, this.minPlayers = 1, this.maxPlayers = 20, this.autoStart = true, final  Map<String, Object?> options = const {}}): _options = options,super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _GameConfig&&(identical(other.gameType, gameType) || other.gameType == gameType)&&(identical(other.adminID, adminID) || other.adminID == adminID)&&(identical(other.nameSet, nameSet) || other.nameSet == nameSet)&&(identical(other.customNames, customNames) || other.customNames == customNames)&&(identical(other.rounds, rounds) || other.rounds == rounds)&&(identical(other.minPlayers, minPlayers) || other.minPlayers == minPlayers)&&(identical(other.maxPlayers, maxPlayers) || other.maxPlayers == maxPlayers)&&(identical(other.autoStart, autoStart) || other.autoStart == autoStart)&&const DeepCollectionEquality().equals(other._options, _options));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,gameType,adminID,nameSet,customNames,rounds,minPlayers,maxPlayers,autoStart,const DeepCollectionEquality().hash(_options));
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,gameID,const DeepCollectionEquality().hash(players),player,creator,config,status);
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Lobby&&(identical(other.code, code) || other.code == code)&&(identical(other.config, config) || other.config == config)&&(identical(other.gameStatus, gameStatus) || other.gameStatus == gameStatus)&&const DeepCollectionEquality().equals(other.players, players));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,code,config,gameStatus,const DeepCollectionEquality().hash(players));
