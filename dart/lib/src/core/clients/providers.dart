...
final playerIDProvider = Provider<PlayerID>((ref) => '', name: 'PlayerID');

/// Allows one config to write all players' configs
final singleConfig = StateProvider<GameConfig>((ref) => const GameConfig(gameType: ''), name: 'SingleGameConfig');
...
final serviceType = StateProvider<ServiceType>((ref) => OnDeviceService, name: 'ClientType');

final allServiceTypes = StateProvider<List<ServiceType>>((ref) => [OnDeviceService], name: 'AllServiceTypes');
