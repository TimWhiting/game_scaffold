...
final multiplayerGameClientProvider =
    StateNotifierProvider.family<MultiplayerGameClient, GameClientInfo, PlayerID>(
...
class MultiplayerGameClient extends StateNotifier<GameClientInfo> {
  ...
  Future<PlayerName?> joinGame() =>
      service((c) => c.joinGame(multiplayerID, state.code!, state.playerName ?? ''));
