...
@protected RoundService? get service; String get code; PlayerName get playerName; GameInfo? get lobby; GameState? get game; String? get error;
...
@override
int get hashCode => Object.hash(runtimeType,service,code,playerName,lobby,game,error);
...
@useResult
$Res call({
@protected RoundService? service, String code, PlayerName playerName, GameInfo? lobby, GameState? game, String? error
});
...
as GameState?,error: freezed == error ? _self.error : error // ignore: cast_nullable_to_non_nullable
as String?,
  ));
}
/// Create a copy of RoundInfo
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@protected  RoundService? service,  String code,  PlayerName playerName,  GameInfo? lobby,  GameState? game,  String? error)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _RoundInfo() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@protected  RoundService? service,  String code,  PlayerName playerName,  GameInfo? lobby,  GameState? game,  String? error)  $default,) {final _that = this;
switch (_that) {
case _RoundInfo():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@protected  RoundService? service,  String code,  PlayerName playerName,  GameInfo? lobby,  GameState? game,  String? error)?  $default,) {final _that = this;
switch (_that) {
case _RoundInfo() when $default != null:
return $default(_that.service,_that.code,_that.playerName,_that.lobby,_that.game,_that.error);case _:
  return null;
